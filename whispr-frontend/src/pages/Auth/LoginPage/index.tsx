        ...
        <div className="flex flex-col items-center justify-center gap-5">
          <div className="flex flex-col items-center justify-center">
            <h1 className="font-bold font-monte sm:text-xl">
              Welcome Back to{" "}
              <span className="sm:text-2xl text-xl text-[#7741f4]">
                Whispr.
              </span>
            </h1>
          ...
          <form className="flex flex-col gap-4 text-xs sm:text-sm w-full">
            ...
            <div className="flex flex-col gap-4 px-2">
              ...
              <p className="text-[9px] font-light ml-auto">
                Forgot your password?{" "}
                <span className="font-semibold text-[10px] underline underline-offset-1">
                  Reset it here
                </span>
              </p>
