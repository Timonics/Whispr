...
const SendMessageInfo: React.FC = () => {
  return (
    <div className="h-full flex flex-col justify-center items-center relative gap-5">
      <div className="flex flex-col items-center">
        ...
        <h1 className="text-2xl lg:text-3xl font-extrabold font-pops text-[#7741f4]">Whispr.</h1>
      </div>
